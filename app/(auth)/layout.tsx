          ...
          <div className="max-w-xl lg:max-w-3xl">
            <div className="relative -mt-16 block lg:hidden">
              ...
              <p className="mt-4 leading-relaxed text-gray-500 dark:text-gray-400 mb-4">
                ...
                you&rsquo;re planning for a big purchase or simply want to manage daily expenses, MoneyMap guides you
                every step of the way. Navigate your financial future with confidence and ease.
              </p>
            </div>
